      ...
      <div className="relative w-full max-w-sm mx-4">
        ...
        >
          <div className="mb-8 text-center">
            ...
            <h2 className="text-[#1a2e2e] text-2xl"
              style={{ fontFamily: 'DM Serif Display, serif' }}>Reset Password</h2>
          ...
          {sent ? (
            <div className="py-4 text-center">
              ...
              <p className="text-[#6b8a82] text-xs mt-1 mb-6">Check your inbox for instructions.</p>
              <Link to="/" className="text-xs font-semibold text-[#0F5C5C] no-underline">
                ← Back to login
              </Link>
            </div>
          ) : (
            <div className="flex flex-col gap-4">
              ...
              <Link to="/" className="block text-center text-[#6b8a82] text-xs no-underline">
                ← Back to login
              </Link>
            </div>
          )}
