...
export default function Login() {
  ...
  // Shared input style — teal stroke always visible, shadow only on hover/focus
  const inputBase = {
    background: '#FAF9F7',
      ...
      <div className="w-full max-w-sm mx-4 relative">
        ...
        >
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="w-full rounded-xl py-3 text-white text-sm font-semibold border-none cursor-pointer mt-1"
